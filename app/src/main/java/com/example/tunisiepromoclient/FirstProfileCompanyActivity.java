...
public class FirstProfileCompanyActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_first_profile_company);
        ...
        CNameEditText=findViewById(R.id.editTextCName);
        ...
        logout.setOnClickListener(view -> {
            Intent intent=new Intent(FirstProfileCompanyActivity.this,MainActivity.class);
                ...
                if (task.isSuccessful()) {
                    ...
                    if (document.exists()) {
                        ...
                        if (userInfo != null) {
                            ...
                            CNameEditText.setText(companyname);
                            if(number!=0){
        ...
        updateProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(FirstProfileCompanyActivity.this, "PROFILE MODIFIED.", Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(FirstProfileCompanyActivity.this,PublicationActivity.class);
                startActivity(intent);
            }
        });
    ...
    private void updateProfiletoFirestore() {
        String companyname =CNameEditText.getText().toString().trim();
        ...
        if (!email.isEmpty()&&selectedImageUri != null) {
            StorageReference storageRef = FirebaseStorage.getInstance().getReference("imageCompany/"+userid+"/image.jpg");
